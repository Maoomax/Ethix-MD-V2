...
const config = {
  SESSION_ID: process.env.SESSION_ID || "Ethix-MD&gxXGAMUm",
  ...
  OWNER_NAME: process.env.OWNER_NAME || "✪⏤͟͞★⃝MANOOSHA-𝞛𝘿𖥘✪͜͡➺",
  OWNER_NUMBER: process.env.OWNER_NUMBER || "94786501525",
